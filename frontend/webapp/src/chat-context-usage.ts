...
export function estimateContextUsage(opts: {
  ...
  const items: CtxItem[] = [
    { key: 'sys', label: 'System Prompt', tokens: SYS_BASE, cls: 'c-sys', pct: 0 },
    { key: 'tools', label: 'Tools', tokens: toolTokens, cls: 'c-tools', pct: 0 },
    { key: 'msg', label: 'Conversation', tokens: msgTokens, cls: 'c-msg', pct: 0 },
    { key: 'mcp', label: 'MCP', tokens: MCP_BASE, cls: 'c-mcp', pct: 0 },
    { key: 'skill', label: 'Skills', tokens: SKILL_BASE, cls: 'c-skill', pct: 0 },
  ];
...
export function selectContextUsage(opts: {
  ...
  if (u) {
    const items: CtxItem[] = [
      { key: 'sys', label: 'System Prompt', tokens: u.breakdown.system, cls: 'c-sys', pct: 0 },
      { key: 'tools', label: 'Tools', tokens: u.breakdown.tools, cls: 'c-tools', pct: 0 },
      { key: 'msg', label: 'Conversation', tokens: u.breakdown.messages, cls: 'c-msg', pct: 0 },
      { key: 'mcp', label: 'MCP', tokens: u.breakdown.mcp, cls: 'c-mcp', pct: 0 },
      { key: 'skill', label: 'Skills', tokens: u.breakdown.skills, cls: 'c-skill', pct: 0 },
    ];
