  ...
  render() {
    if (this.loading) {
      ...
      return html` <div class="wrap">
        <h2>插件管理</h2>
        <p class="hint">
          运行时启停 / 升级插件，无需重启服务进程；操作受服务端 plugin:manage
          权限保护。
        </p>
        <div class="panel">
          <table>
            ...
            <tbody>
              ${[0, 1, 2, 3].map(
                (i) => html` <tr>
                  <td data-label="ID">
                    <span class="sk-cell" style="width:80%"></span>
                  </td>
                  <td data-label="名称">
                    <span class="sk-cell" style="width:70%"></span>
                  </td>
                  <td data-label="版本">
                    <span class="sk-cell" style="width:50%"></span>
                  </td>
                  <td data-label="状态">
                    <span class="sk-cell" style="width:60%"></span>
                  </td>
                  <td data-label="依赖">
